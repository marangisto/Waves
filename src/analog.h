...
static const uint8_t adc_buf_size = 6;
...
template<> inline uint16_t read<1>() { return adc_buf[2]; }
template<> inline uint16_t read<2>() { return adc_buf[4]; }
